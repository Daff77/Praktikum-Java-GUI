...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try (Connection conn = koneksi.getConnection()) {
            ...
            if (rs.next()) {
                ...
                // Set session menggunakan method
                ...
                // Buka WelcomeFrame
                new WelcomeFrame(Session.username, Session.role).setVisible(true);
                this.dispose();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Object[] message = {
            "Username Admin:", txtUsername,
            "Password Admin:", txtPassword
        };

        int option = JOptionPane.showConfirmDialog(this,
                message, "Login Admin", JOptionPane.OK_CANCEL_OPTION);
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            if (validateAdminCredentials(username, password)) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Credential admin salah!", "Login Gagal", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private boolean validateAdminCredentials(String username, String password) {
        try (Connection conn = koneksi.getConnection()) {
            PreparedStatement stmt = conn.prepareStatement(
                    "SELECT username FROM users WHERE username = ? AND password = ? AND role = 'admin'"
            );
            stmt.setString(1, username);
            stmt.setString(2, password);
            ResultSet rs = stmt.executeQuery();
